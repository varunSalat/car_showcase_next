...
import { getCarsImage } from "@/utils";

interface ICarsPropDetails {
  isOpen: boolean;
  CloseModel: () => void;
  car: ICarsProp;
}

const CarDetails = ({ isOpen, CloseModel, car }: ICarsPropDetails) => {
  return (
    <>
              ...
              >
                ...
                >
                  <button
                    type="button"
                    onClick={CloseModel}
                    className="absolute top-2 right-2 p-2 w-fit z-10 bg-primary-blue-100 rounded-full"
                  >
                    <Image
                      src="/close.svg"
                      alt="close"
